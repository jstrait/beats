  ...
  <div class="content-box" id="drum-kits">
    ...
    <ul>
      <li id="drumkit-hammerhead" class="drumkit">
        ...
        <p>371 sounds liberated from various <a href="http://www.threechords.com/hammerhead/introduction.shtml">Hammerhead</a> sound banks using <a href="https://github.com/jstrait/clawhammer">Clawhammer</a>.</p>
